...
| Data | 110˚C | 6µm |
    ...
    with open('sampledb/schemas/plotly.json', 'r') as schema_file:
        schema = json.load(schema_file)
    ...
    with open('example_data/plotly-example-data1.sampledb.json', 'r') as data_file:
    ...
    with open('sampledb/schemas/plotly_array.json', 'r') as schema_file:
        schema = json.load(schema_file)
    ...
    with open('example_data/plotly-example-data2.sampledb.json', 'r') as data_file:
        example_data2 = json.load(data_file, parse_float=decimal.Decimal)
    with open('example_data/plotly-example-data3.sampledb.json', 'r') as data_file:
