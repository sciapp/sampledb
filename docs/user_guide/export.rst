...
Additionally a file ``ro-crate-metadata.json.minisig`` is included, which contains a signature generated with `minisign <https://github.com/x13a/py-minisign>`_. This signature can be used to validate the data of this ELN file when importing it to another instance.
