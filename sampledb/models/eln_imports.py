...
class ELNImport(Model):
    ...
    upload_utc_datetime: Mapped[datetime.datetime] = db.Column(db.DateTime, nullable=False)
    import_utc_datetime: Mapped[typing.Optional[datetime.datetime]] = db.Column(db.DateTime, nullable=True)
