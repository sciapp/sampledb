...
from .federation import UpdateHook, ImportStatus, Objects, Users, File, Components, Languages, FederatedLoginMetadata
...
federation_api.add_url_rule('/federation/v1/shares/languages/', endpoint='languages', view_func=Languages.as_view('languages'))
