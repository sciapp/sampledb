...
from ...logic import user_log, users, errors
...
def user_activity(user_id):
    ...
    return flask.render_template('user_activity.html', user_log_entries=user_log_entries, UserLogEntryType=user_log.UserLogEntryType, user=user)
