...
def get_object_table_with_permissions(
    ...
    if name_only:
        ...
        stmt = """
        SELECT
        o.object_id, o.version_id, o.action_id, o.data, o.schema, o.user_id, o.utc_datetime, o.fed_object_id, o.fed_version_id, o.component_id, o.eln_import_id, o.eln_object_id, o.version_component_id, o.hash_data, o.hash_metadata, o.data as data_full
        FROM objects_current AS o
        """
