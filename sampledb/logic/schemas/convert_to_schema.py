...
def convert_to_schema(data: dict, previous_schema: dict, new_schema: dict) -> typing.Tuple[typing.Any, typing.Sequence[str]]:
    ...
    """
    if new_schema == previous_schema and new_schema['type'] in ('bool', 'text', 'datetime', 'tags', 'sample', 'quantity', 'array', 'objects'):
        return data, []
    ...
    if new_schema['type'] in ('bool', 'text', 'datetime', 'tags', 'sample'):
        return data, []
