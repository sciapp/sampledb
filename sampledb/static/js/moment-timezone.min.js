!function (a, i) {
    ...
    var a = c.version.split("."), e = +a[0], r = +a[1];
    ...
    function p(a) {
        ...
        return f(e), f(r), f(o), function (a, i) {
            ...
            a[i - 1] = 1 / 0
        }(o, r.length), {name: i[0], abbrs: l(i[1].split(" "), r), offsets: l(e, r), untils: o, population: 0 | i[5]}
    }
    ...
    function P() {
        ...
        var e, r, o, c = function () {
            ...
            return c
        }(), A = c.length, n = function (a) {
            var i, e, r, o = a.length, c = {}, A = [];
    ...
    function L(a) {
        var i = Array.prototype.slice.call(arguments, 0, -1), e = arguments[arguments.length - 1], r = _(e),
    ...
    (e < 2 || 2 == e && r < 6) && O("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + c.version + ". See momentjs.com"), M.prototype = {
        ...
        return i ? e.map(function (a) {
            return {name: a, offset: _(a).utcOffset(new Date)}
        }) : e
    };
    var y, N = c.fn;
