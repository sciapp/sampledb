...
$(function () {
  ...
  if (window.template_values.current_user.has_timezone) {
    $('span[data-utc-datetime]').each(function (_, element) {
      ...
      const langCode = window.template_values.current_user.language.lang_code;
      const format = window.template_values.current_user.language.datetime_format_moment_output;
  ...
  if (window.template_values.notifications.num_urgent_notifications) {
    ...
    let hideNotifications = window.template_values.notifications.hide_notifications;
