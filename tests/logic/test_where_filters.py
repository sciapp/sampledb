...
def languages(engine):
    sampledb.models.Component.__table__.create(bind=engine)
    sampledb.models.Language.__table__.create(bind=engine)
    with engine.begin() as connection:
        query = db.text('''
            INSERT INTO languages
            (id, lang_code, names, datetime_format_datetime, datetime_format_moment, enabled_for_input, fed_lang_id, component_id)
            VALUES
            (:language_id, :lang_code, '{}', '', '', true, null, null)
        ''')
...
def test_text_equals(objects, languages):
    objects.create_object(action_id=0, data={'t': datatypes.Text("Beispiel")}, schema={}, user_id=0, calculate_hashes=False)
    object1 = objects.create_object(action_id=0, data={'t': datatypes.Text("Example")}, schema={}, user_id=0, calculate_hashes=False)
...
def test_text_equals_multiple_languages(objects, languages):
    objects.create_object(action_id=0, data={'t': datatypes.Text("Beispiel")}, schema={}, user_id=0, calculate_hashes=False)
    object1 = objects.create_object(action_id=0, data={'t': datatypes.Text({'en': "Example", 'de': "Beispiel"})}, schema={}, user_id=0, calculate_hashes=False)
...
def test_boolean_equals(objects):
    object1 = objects.create_object(action_id=0, data={'b': datatypes.Boolean(True)}, schema={}, user_id=0, calculate_hashes=False)
    object2 = objects.create_object(action_id=0, data={'b': datatypes.Boolean(False)}, schema={}, user_id=0, calculate_hashes=False)
...
def test_boolean_true(objects):
    object1 = objects.create_object(action_id=0, data={'b': datatypes.Boolean(True)}, schema={}, user_id=0, calculate_hashes=False)
    objects.create_object(action_id=0, data={'b': datatypes.Boolean(False)}, schema={}, user_id=0, calculate_hashes=False)
    assert [object1] == objects.get_current_objects(lambda data: where_filters.boolean_true(data['b']))


def test_boolean_false(objects):
    objects.create_object(action_id=0, data={'b': datatypes.Boolean(True)}, schema={}, user_id=0, calculate_hashes=False)
    object1 = objects.create_object(action_id=0, data={'b': datatypes.Boolean(False)}, schema={}, user_id=0, calculate_hashes=False)
...
def test_quantity_equals(objects):
    object1 = objects.create_object(action_id=0, data={'q': datatypes.Quantity(1, 'meter')}, schema={}, user_id=0, calculate_hashes=False)
    objects.create_object(action_id=0, data={'q': datatypes.Quantity(1, 'kilometer')}, schema={}, user_id=0, calculate_hashes=False)
...
def test_quantity_equals_epsilon(objects):
    object1 = objects.create_object(action_id=0, data={'q': datatypes.Quantity(10, 'mg')}, schema={}, user_id=0, calculate_hashes=False)
    objects.create_object(action_id=0, data={'q': datatypes.Quantity(9.99, 'mg')}, schema={}, user_id=0, calculate_hashes=False)
...
def test_quantity_greater_than(objects):
    object1 = objects.create_object(action_id=0, data={'q': datatypes.Quantity(-1, 'meter')}, schema={}, user_id=0, calculate_hashes=False)
    objects.create_object(action_id=0, data={'q': datatypes.Quantity(-200, 'centimeter')}, schema={}, user_id=0, calculate_hashes=False)
    ...
    object1 = objects.create_object(action_id=0, data={'q': datatypes.Quantity(1, 'meter')}, schema={}, user_id=0, calculate_hashes=False)
    objects.create_object(action_id=0, data={'q': datatypes.Quantity(1, 'centimeter')}, schema={}, user_id=0, calculate_hashes=False)
...
def test_quantity_between_excluding(objects):
    ...
    object1 = objects.create_object(action_id=0, data={'q': datatypes.Quantity(-1, 'meter')}, schema={}, user_id=0, calculate_hashes=False)
    objects.create_object(action_id=0, data={'q': datatypes.Quantity(-10, 'centimeter')}, schema={}, user_id=0, calculate_hashes=False)
...
def test_datetime_equals(objects):
    ...
    object1 = objects.create_object(action_id=0, data={'dt': datatypes.DateTime(utc_datetime)}, schema={}, user_id=0, calculate_hashes=False)
    objects.create_object(action_id=0, data={'dt': datatypes.DateTime(utc_datetime - datetime.timedelta(days=1))}, schema={}, user_id=0, calculate_hashes=False)
...
def test_sample_equals(objects):
    object1 = objects.create_object(action_id=0, data={}, schema={}, user_id=0, calculate_hashes=False)
    object2 = objects.create_object(action_id=0, data={'t': {'_type': 'sample', 'object_id': object1.object_id}}, schema={}, user_id=0, calculate_hashes=False)
...
def test_reference_equals(objects):
    object1 = objects.create_object(action_id=0, data={}, schema={}, user_id=0, calculate_hashes=False)
    object2 = objects.create_object(action_id=0, data={'t': {'_type': 'sample', 'object_id': object1.object_id}}, schema={}, user_id=0, calculate_hashes=False)
    object3 = objects.create_object(action_id=0, data={'t': {'_type': 'measurement', 'object_id': object1.object_id}}, schema={}, user_id=0, calculate_hashes=False)
    object4 = objects.create_object(action_id=0, data={'t': {'_type': 'object_reference', 'object_id': object1.object_id}}, schema={}, user_id=0, calculate_hashes=False)
    object5 = objects.create_object(action_id=0, data={'t': {'_type': 'user', 'user_id': object1.object_id}}, schema={}, user_id=0, calculate_hashes=False)
    object6 = objects.create_object(action_id=0, data={'t': {'_type': 'object_reference', 'object_id': object1.object_id + 1}}, schema={}, user_id=0, calculate_hashes=False)
    object7 = objects.create_object(action_id=0, data={'t': {'_type': 'user', 'user_id': object1.object_id + 1}}, schema={}, user_id=0, calculate_hashes=False)
