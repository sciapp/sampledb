...
def test_set_instrument_translation():
    ...
    for instrument_translation in instrument_translations.get_instrument_translations_for_instrument(
            instrument_id=instrument.id
    ):
        if instrument_translation.language_id == sampledb.logic.languages.Language.ENGLISH:
