...
def test_text_equals(objects):
    objects.create_object(data={'t': datatypes.Text("Beispiel")}, schema={}, user_id=0)
    object1 = objects.create_object(data={'t': datatypes.Text("Example")}, schema={}, user_id=0)
...
def test_boolean_equals(objects):
    object1 = objects.create_object(data={'b': datatypes.Boolean(True)}, schema={}, user_id=0)
    object2 = objects.create_object(data={'b': datatypes.Boolean(False)}, schema={}, user_id=0)
...
def test_boolean_true(objects):
    object1 = objects.create_object(data={'b': datatypes.Boolean(True)}, schema={}, user_id=0)
    objects.create_object(data={'b': datatypes.Boolean(False)}, schema={}, user_id=0)
    assert [object1] == objects.get_current_objects(lambda data: where_filters.boolean_true(data['b']))


def test_boolean_false(objects):
    objects.create_object(data={'b': datatypes.Boolean(True)}, schema={}, user_id=0)
    object1 = objects.create_object(data={'b': datatypes.Boolean(False)}, schema={}, user_id=0)
...
def test_quantity_equals(objects):
    object1 = objects.create_object(data={'q': datatypes.Quantity(1, 'meter')}, schema={}, user_id=0)
    objects.create_object(data={'q': datatypes.Quantity(1, 'kilometer')}, schema={}, user_id=0)
...
def test_quantity_greater_than(objects):
    object1 = objects.create_object(data={'q': datatypes.Quantity(1, 'meter')}, schema={}, user_id=0)
    objects.create_object(data={'q': datatypes.Quantity(1, 'centimeter')}, schema={}, user_id=0)
...
def test_datetime_equals(objects):
    ...
    object1 = objects.create_object(data={'dt': datatypes.DateTime(utc_datetime)}, schema={}, user_id=0)
    objects.create_object(data={'dt': datatypes.DateTime(utc_datetime - datetime.timedelta(days=1))}, schema={}, user_id=0)
